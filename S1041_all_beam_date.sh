...
do
    python2.7 find_sources.py --field S1041+027 --band band0 --date "$i"   --beam 0 1 2 3 4 5 6  --verbose --file_verbose --exclude_channels  2748 2749 2750 2751 2752 2753  --data_filepath /n/fox/processed/S1_CALS --num_source_points 12 --point_sep 1 --num_outer_points 10  --rfi_mask 25 --format ascii
done 
